...
<div class="w-[296px] contact-us-container duration-300"> 
    <div id="mo_contact_us" class="flex gap-mo-4 relative justify-end">
        ...
        <div class="mo_contactus_popup_container" style="display:none;"></div>
                ...
                <input type="hidden" name="option" value="mogf_validation_contact_us_query_option">
                        ...
                        <input type="text" class="mo-input" name="query_phone" id="query_phone" value="' . esc_attr( $phone ) . '"
                            ...
                            <textarea id="contactQuery" name="query" class="mo-textarea h-[100px]"
                                ...
                                placeholder="' . esc_attr( mogf_( 'Write your query here...' ) ) . '"></textarea>
              
                                <input type="submit" name="send_query" id="send_query" value="' . esc_attr( mogf_( 'Submit Query' ) ) . '" 
