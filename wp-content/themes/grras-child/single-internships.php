        ...
        <?php if(have_rows('banner_banner_tags')): ?>
          ...
          <ul class="list-unstyled">
            ...
            <li class="list-inline-item">
              ...
              <span class="bg-white-sm p-2 rounded-1 theme-text-primary fw-semibold font-14">
...
.inten-banner .wid160 {
    ...
    width: 160px;
	    ...
	    <div class="turnover pt-0 turnover-detail">
			...
			<div class="container">
				...
				<div class="col-12 col-lg-6 mb-4 mb-lg-0">
					...
					<div class="heading-area">
						...
						$short_text = mb_substr($full_text, 0, 400);

						$is_long = mb_strlen($full_text) > 400;
						...
						<div class="mb-1 readmoretext">
							...
							<?php if ($is_long): ?>
								...
								<span class="more-text d-none"><?php echo wp_kses_post(mb_substr($full_text, 400)); ?></span>
	        ...
	        <div class="intcert">
	          ...
	          <div class="row justify-content-between align-items-center">
	            ...
	            <div class="col-lg-6 order-md-first">
	              ...
	              <div class="text-center d-block d-md-none mt-5"><a href="#" class="btn btn-primary mt-2">Apply for Intermship</a></div>
			...
			<div class="tabbed-content">
				...
				<div class="container d-none d-md-block">
					...
					<div class="row">
						...
						<h2 class="text-center"><?php echo get_field('top_career_options_heading'); ?></h2>

						<p class="text-center"><?php echo get_field('top_career_options_subheading'); ?></p>
							...
							<?php 
								...
								if(have_rows('top_career_options_tabs')) :
									...
									while(have_rows('top_career_options_tabs')): the_row();
										...
										$annualSalText = get_sub_field('annual_salary_image_description');
										...
										$hiringCompanyText = get_sub_field('hiring_company_image_description');
							...
							<section id="<?php echo $tab_id; ?>" class="item <?php echo (get_row_index() == 1) ? 'active' : ''; ?>" data-title="<?php echo $tab_title; ?>">
								...
								<div class="item-content">
									...
									<div class="col-lg-6 text-center">
										...
										<?php if(!empty($annualSalText)): ?>

										<p><?php echo $annualSalText; ?></p>
									...
									<div class="col-lg-6 text-center">
										...
										<?php if(!empty($hiringCompanyText)): ?>

										<p><?php echo $hiringCompanyText; ?></p>
...
<?php endif; ?>
    ...
    <div class="tools-section help-section bg-image-hide wow fadeInUp bg-theme-light py-5 position-relative">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center mb-3">
          ...
          <div class="col-12 col-lg-12">
            ...
            <div class="heading-area">
              ...
              <h2 class=""><?php echo get_field('get_ahead_in_your_career_by_learning_top_ai_tools_title'); ?></h2>
        ...
        $items = get_field('get_ahead_in_your_career_by_learning_top_ai_tools_items');

        if(have_rows('get_ahead_in_your_career_by_learning_top_ai_tools_items')):
          ...
          <div class="col-12 col-sm-12 col-lg-12">
            ...
            <div class="card border brd-theme rounded-4 h-100">
              ...
              <div class="card-body p-lg-4">
                  ...
                  <?php while (have_rows('get_ahead_in_your_career_by_learning_top_ai_tools_items')): the_row(); ?>
                      ...
                      <div class="d-flex gap-3 align-items-center mb-2">
                          ...
                          <p class="theme-text-light mb-0"><?php echo get_sub_field('item_description'); ?></p>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 text-center">
            ...
            <h2 class="mb-0"><?php echo get_field('essential_full_stack_development_tools_covered_in_this_course_heading'); ?></h2>
    ...
    <section class="faqs faq-section py-5">
      ...
      <div class="container wow fadeInUp">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-12">
            ...
            <div class="heading-area mb-4">
              ...
              <h2 class="fw-bold"><?php echo $internship_detail_page['from_training_to_placement_a_roadmap_to_success_title']; ?></h2>
        ...
        $tabsData = $internship_detail_page['from_training_to_placement_a_roadmap_to_success_tabs'];
		...
		$attachment_id = $internship_detail_page['our_mission_download_placement_report_file'];
		...
		$attachment_right_id = $internship_detail_page['our_mission_right_image'];
          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-8 order-2 order-lg-1">
              ...
              <div class="dataarea p-3">
                ...
                <span><?php echo $internship_detail_page['our_mission_revolves_around_our_learners_title']; ?></span>

                <h4 class="fw-bold my-md-3"><?php echo $internship_detail_page['our_mission_revolves_around_our_learners_subheading']; ?></h4>
...
?>
	            ...
	            <div class="text-center mt-5"><a href="<?php echo site_url('aboutus?tab=partnerssection'); ?>" class="btn btn-primary text-14">See All Our Hiring Partners</a></div>
...
?>
	    ...
	    <div class="whygrras beint no-bg pt-0">
