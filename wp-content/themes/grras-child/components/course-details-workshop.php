...
<div class="workshop wow fadeInLeft">
    <div class="container">
        <h2>Join Our Exclusive Workshops!</h2>
        <div class="subtext">Discover daily sessions covering business analytics, graphic design, Python, and more. Reserve your spot today!</div>
