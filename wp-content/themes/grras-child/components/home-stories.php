...
?>
    ...
    <?php
            ...
            ?>
                    <div class="youtubeModal modal fade" data-owl-carousel=".success-story" id="exampleModal-<?php echo $i; ?>" tabindex="-1" aria-labelledby="exampleModal-<?php echo $i; ?>" aria-hidden="true">
