  ...
  <!-- new html -->
  <div class="recentplacement whychoose wow fadeInLeft">
      <div class="tabbed-content">
        ...
        <?php
             ...
             <div class="text-center mt-5"><a href="/review-rating" class="btn btn-primary">Read All Success Stories</a></div>
            </div>
          </section>
