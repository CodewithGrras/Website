<div class="tools wow fadeInUp">
  <div class="container">
    <h2><?php echo get_field('course_project_heading_and_tags_heading')['tags_heading']; ?></h2>
    <ul>
      <?php
...
$tags = get_the_terms($post_id, $taxonomy);
      ...
      if ( ! empty( $tags ) && ! is_wp_error( $tags ) ) :
        ...
        foreach ( $tags as $tag ) :
          ...
          ?>
          <li>
              <a href="<?php echo esc_url( $tag_permalink ); ?>" style="text-decoration: none;">
            <div class="imgbox">
              <img src="<?php echo esc_url( $image_url ); ?>" class="img-fluid" alt="<?php echo esc_attr( $image_alt ); ?>" />
            </div>
