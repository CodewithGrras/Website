...
.workbanner.mobile {
    background: url(<?php echo $banner['background_image_mobile'] ?>) no-repeat center top;
    background-size: cover;
    padding: 30px 0 0;
}
...
<!-- work banner -->
<div class="workbanner desktop d-none d-md-block wow fadeInUp">
    <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-6">
            <div class="leftcontent" style="visibility: hidden;">
...
<div class="workbanner mobile d-md-none d-block wow fadeInUp">
    <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-6">
            <div class="leftcontent" style="visibility: hidden;">
