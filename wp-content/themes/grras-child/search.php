...
<div class="col-lg-3">
          ...
          <div class="col-lg-7">
            ...
            <h2 class="fw-semibold mt-0 mb-4"><?php 
 ...
 Resources found for “<?php echo $search?>”</h2>
        ...
        ?>
            ...
            <div class="intcourse coursesec d-block d-sm-none p-0">
              ...
              <div class="course-mobile search-mobile">
        ...
        if ($courses_query->have_posts()) :
          ...
          while ($courses_query->have_posts()) : $courses_query->the_post();
            ...
            ?>
                 ...
                 <a href="<?php the_permalink(); ?>" class="course-mobile search-mobile-s">
...
showItems('view-more-5','#row-container-5','.course-mobile search-mobile-s','program-count-5');

showDefault('view-more-5','#row-container-5 .course-mobile search-mobile-s','#row-container-5','.course-mobile search-mobile-s','program-count-5',6);
